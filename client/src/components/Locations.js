...
const Locations = (props) =>{
    ...
    const handleDelete = async () =>{
        axios
            .delete(`http://localhost:8000/api/locations/${locationDelete._id}`, {withCredentials:true})
            .then(res => {
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Deleting a location is permentant and cannot be undone. <br/><br/> Do you wish you to continue deleting {locationDelete.name}?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
